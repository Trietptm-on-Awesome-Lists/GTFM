...
<a id="uno" href="#-1-smashing-stack-sobreescribiendo-eip-con-una-direccion-de-memoria-controlada-por-nosotros--float-value--shellcode"><h2> #1# Smashing Stack sobreescribiendo EIP con una direccion de memoria controlada por nosotros + float value + shellcode</h2></a>
